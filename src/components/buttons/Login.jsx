...
const Login = () => {
    return (
        <>
            <button type="button" className="btn btn-outline-primary ms-auto" data-bs-toggle="modal" data-bs-target="#singinModal">
               <span className="fa fa-sign-in me-1"></span> Singin
            </button>
